...
var UserController = /** @class */ (function () {
    function UserController() {
        ...
        this.uploadPhotoAsync = function (uri, filename) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    upload.on("state_changed", function (err) {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, upload.snapshot.ref.getDownloadURL()];
                                                case 1:
                                                    url = _a.sent();
                                                    res(url);
                                                    return [2 /*return*/];
        ...
        this.createUser = function (user) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 5, , 6]);
                        db = this.userCollection.doc(this.uid);
    ...
    Object.defineProperty(UserController.prototype, "userCollection", {
        /*   get user() {
          const user = null;
          this.userCollection
            .doc(this.uid)
